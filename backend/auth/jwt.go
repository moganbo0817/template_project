...
func (j *JWTer) GenerateToken(ctx context.Context, u entity.User) ([]byte, error) {
	...
	// Sign JWT
	signed, err := jwt.Sign(tok, jwt.WithKey(jwa.RS256, j.PrivateLey))
	if err != nil {
		return nil, err
	}
	return signed, nil
...
func (j *JWTer) FilContext(r *http.Request) (*http.Request, error) {
