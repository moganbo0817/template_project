...
import (
	...
	"github.com/moganbo0817/template_project/testutil/fixture"
)
...
func TestJWTer_GetJWT(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/moganbo0817/template_project`).
	...
	req := httptest.NewRequest(
		http.MethodGet,
		`https://github.com/moganbo0817/template_project`,
		nil,
	)
...
type FixedTommrowClocker struct{}

func (c FixedTommrowClocker) Now() time.Time {
